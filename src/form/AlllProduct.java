...
public class AlllProduct extends javax.swing.JFrame {
    ...
    private void tableProduct(){
        ...
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new AlllProduct.ImageRender());
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (double i = 0.1; i <= 1.0; i += 0.1) {
            ...
            try {
                ...
                Logger.getLogger(AlllProduct.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlllProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
