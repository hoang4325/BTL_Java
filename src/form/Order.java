...
public class Order extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tổng tiền (VNĐ): 0 Đ");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (jTextField3.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Hãy nhập số lượng!", "Warning", 2);
        } else {
            try {
                ...
                if (!dao.isProductExist(cid, proId)) {
                    ...
                    jLabel1.setText(String.format("Tổng tiền (VNĐ): " + "%.2f", total));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(total != 0.0){
            ...
            JOptionPane.showMessageDialog(this, "Bạn chưa mua bất kì sản phẩm nào", "Warning", 2);
        }
    ...
    private void tableProduct() {
        ...
        jTable1.getColumnModel().getColumn(3).setCellRenderer(new Order.ImageRender());
    }
